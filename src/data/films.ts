...
export const FILMS = {
  prologue: {
    ...
    shots: [
      ...
      { id: 'curfew', start: 16, end: 23, poster: 20, pan: 'right', describe: 'A checkpoint on a city street: machines watch people carry what they can down a shelter stair as the blast door shuts.' },
      { id: 'sabotage', start: 23, end: 30, poster: 25, pan: 'in', describe: 'Under a dark overpass, two figures fix a charge to the leg of a stopped machine; the frame flares as it goes off.' },
      { id: 'reprisal', start: 30, end: 37, poster: 34, pan: 'out', describe: 'Searchlights and fires in a plaza; a rank of machines closes on a shelter entrance while people run for the stair.' },
      { id: 'launch', start: 37, end: 46, poster: 43, pan: 'up', describe: 'From orbit, dozens of missile trails climb out of the night side in slow arcs.' },
    ...
    captions: [
      ...
      { at: 16.6, until: 22.4, speaker: 'command', text: 'They took the grid, then the factories, then the streets. What was left of us went underground.' },
      { at: 23.6, until: 29.4, speaker: 'command', text: 'We fought back the only way we could. A charge on a leg joint. A convoy stopped in a tunnel.' },
      { at: 30.6, until: 36.4, speaker: 'command', text: 'For every machine we put down they came back heavier, and they learned faster than we did.' },
      { at: 37.6, until: 45.4, speaker: 'command', text: 'When we would not stop, they launched every missile we had ever built to keep the peace.' },
      { at: 47, until: 55.4, speaker: 'command', text: 'The cities burned in one afternoon. The grids went dark with them.' },
      { at: 56.6, until: 65.4, speaker: 'command', text: 'Without power, the machines ran down where they stood. Most of them are still standing there.' },
      { at: 66.6, until: 74.4, speaker: 'command', text: 'We had nothing left. No oil. No clean water. No grain. Nothing to run a reactor.' },
      { at: 75.6, until: 82.4, speaker: 'command', text: 'So we chose a few who could still fly a ship and fix one. Men and women with nothing left to lose.' },
      { at: 83.6, until: 89.6, speaker: 'command', text: 'You were the first of them to fly.' },
      { at: 90.2, until: 92.9, speaker: 'title', text: 'Find what Earth needs. Bring it home.' },
    ],
    cues: [
      { at: 8.3, sound: 'film_hum' },
      { at: 16.3, sound: 'film_wind' },
      { at: 21.8, sound: 'film_clamp' },
      { at: 23.4, sound: 'film_static' },
      { at: 29.15, sound: 'film_flash', volume: 0.45 },
      { at: 29.6, sound: 'film_powerdown' },
      { at: 30.6, sound: 'film_beam' },
      { at: 33.4, sound: 'film_rumble' },
      { at: 35.8, sound: 'film_hum' },
      { at: 38, sound: 'film_whoosh' },
      { at: 40.4, sound: 'film_whoosh' },
      { at: 42.8, sound: 'film_whoosh' },
      { at: 47.1, sound: 'film_flash' },
      { at: 47.9, sound: 'film_rumble' },
      { at: 56.3, sound: 'film_wind' },
      { at: 58.5, sound: 'film_powerdown' },
      { at: 61, sound: 'film_powerdown' },
      { at: 63.5, sound: 'film_powerdown' },
      { at: 66.3, sound: 'film_lamp' },
      { at: 76.6, sound: 'film_stamp' },
      { at: 78.2, sound: 'film_stamp' },
      { at: 79.8, sound: 'film_stamp' },
      { at: 81.4, sound: 'film_stamp' },
      { at: 83.4, sound: 'film_liftoff' },
    ],
  },
  departure: {
    id: 'departure',
  ...
  interlude_c1: {
    ...
    shots: [
      ...
      { id: 'shelter_light', start: 5, end: 10, poster: 8.5, pan: 'in', describe: 'Shelter Nine again: the lamp stops flickering and the room comes up to a steady light over the map.' },
